...
namespace TriLibCore.HDRP.Mappers
{
    ...
    public class HDRPMaterialMapper : MaterialMapper
    {
        ...
        private void CheckEmissionColor(MaterialMapperContext materialMapperContext)
        {
            ...
            materialMapperContext.VirtualMaterial.SetProperty("_EmissiveColor", materialMapperContext.Context.Options.LoadTexturesAsSRGB ? value.gamma : value);
            materialMapperContext.VirtualMaterial.SetProperty("_EmissiveColorLDR", materialMapperContext.Context.Options.LoadTexturesAsSRGB ? value.gamma : value);
        ...
        private void CheckDiffuseColor(MaterialMapperContext materialMapperContext)
        {
            ...
            materialMapperContext.VirtualMaterial.SetProperty("_BaseColor", materialMapperContext.Context.Options.LoadTexturesAsSRGB ? value.gamma : value);
            materialMapperContext.VirtualMaterial.SetProperty("_Color", materialMapperContext.Context.Options.LoadTexturesAsSRGB ? value.gamma : value);
        }
